...
public class CarService {
    ...
    public List<Car> list() {
        ...
        cars.forEach(car -> {
            ...
            mapsClient.getAddress(car.getLocation());
        });
        return cars;
    }
    ...
    public Car save(Car car) {
        ...
        Car addedCar = repository.save(car);
        priceClient.addPrice(new Price("USD",
                BigDecimal.valueOf(Double.parseDouble(addedCar.getPrice())),
                addedCar.getId()));
        return addedCar;
    }
